...
#ifndef TESTMAKER_SWIFT_H
#define TESTMAKER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="testMaker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9testMaker11AppDelegate")
...
SWIFT_CLASS("_TtC9testMaker13SceneDelegate")
